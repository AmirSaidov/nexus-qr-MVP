...
import { requestExit, getExitStatus } from "@/lib/places";
...
export const ExitModal = ({ open, onExitSuccess, onClose }: ExitModalProps) => {
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Запросите разрешение у преподавателя
            </p>
          </div>
        </div>
          ...
          {!requestSent ? (
            <>
              ...
              <Button
                ...
                disabled={loading}
                className="w-full h-12 rounded-xl text-sm font-semibold dark:bg-white dark:text-black dark:hover:bg-white/90"
              >
